...
const entityVm = new Vue({
    ...
    data: {
        ...
        currentEntityType: {},
        currentEntitySet: [],
        readonlyProps: [{ propertyName: 'CreateTime' }, { propertyName: 'UpdateTime' }] // Entity只读属性设置
    }
});
...
function addReadonlyProp() {
    entityVm._data.readonlyProps.push({ propertyName: null });
}

// 重置只读属性
function resetReadonlyProps() {
    entityVm._data.readonlyProps = [{ propertyName: 'CreateTime' }, { propertyName: 'UpdateTime' }];
}
